...
import {
	useCreateDeviceSimulation,
	useDeleteDeviceSimulation,
	useStartSimulation,
	useStopSimulation,
	...
	return (
		...
		>
			...
			<div className="electric-meter__gauge-wrapper">
				<svg
					viewBox="0 0 200 120"
					className="electric-meter__gauge"
					aria-label="Electric Meter Gauge"
				>
					<title>Electric Meter Gauge</title>
					<defs>
			...
			<ConnectedDevicesList
				...
				onRemoveDevice={(id: string) =>
					deleteDeviceSimulation({ simulationId: id })
				}
			/>
		</div>
	);
