...
const CreateNewDeviceFooter = () => {
    return (
        <DialogFooter className="flex justify-center">
            ...
            <Button type="submit" className="bg-green-50 text-green-700 ring-green-200 hover:bg-green-200 px-4 py-2 rounded-full text-sm font-medium ring-2 transition" > Create Device </Button>
            </DialogClose>
